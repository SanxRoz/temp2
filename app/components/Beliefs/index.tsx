const Beliefs = () => {
  return (
    <div className="mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8 rounded-3xl">
      <div className="grid grid-cols-1 md:grid-cols-2 my-16 mx-5 gap-5">
        {/* COLUMN-1 */}

        <div className="bg-[#252525] col-span-2 sm:col-span-1 py-12 px-10 sm:px-24 md:pb-70 rounded-3xl shadow-[inset_0_1px_0px_0px_rgba(255,255,255,0.1)]">
        ...
        <div className="bg-build bg-[#252525] col-span-2 sm:col-span-1 py-12 px-10 sm:px-24 md:pb-70 shadow-[inset_0_1px_0px_0px_rgba(255,255,255,0.1)] rounded-3xl">
